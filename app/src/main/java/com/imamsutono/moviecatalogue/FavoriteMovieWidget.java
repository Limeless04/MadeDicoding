...
public class FavoriteMovieWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.imamsutono.moviecatalogue.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.imamsutono.moviecatalogue.EXTRA_ITEM";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(TOAST_ACTION)) {
                ...
                Toast.makeText(context, "You clicked " + viewIndex, Toast.LENGTH_SHORT).show();
            }
        }
    }
}
